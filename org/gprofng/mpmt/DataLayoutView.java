...
public final class DataLayoutView extends FuncListDisp implements AnChangeListener {

  public DataLayoutView() {
    super(AnWindow.getInstance(), AnDisplay.DSP_DataLayout, 0, AnVariable.HELP_TabsDataLayout);
    setAccessibility(AnLocale.getString("Data Layout"));
  ...
  public void stateChanged(AnChangeEvent e) {
    //        System.out.println("DataLayoutView stateChanged:  " + e.getType());
    switch (e.getType()) {
