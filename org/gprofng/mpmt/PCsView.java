...
public final class PCsView extends FuncListDisp implements AnChangeListener {

  public PCsView() {
    super(AnWindow.getInstance(), AnDisplay.DSP_PCs, 0, AnVariable.HELP_TabsPCs);
    setAccessibility(AnLocale.getString("PCs"));
  ...
  public void stateChanged(AnChangeEvent e) {
    //        System.out.println("PCsView stateChanged:  " + e.getType());
    switch (e.getType()) {
