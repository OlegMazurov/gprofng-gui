...
public final class DataObjectsView extends FuncListDisp implements AnChangeListener {

  public DataObjectsView() {
    super(AnWindow.getInstance(), AnDisplay.DSP_DataObjects, 0, AnVariable.HELP_TabsDataObjects);
    setAccessibility(AnLocale.getString("Data Objects"));
  ...
  public void stateChanged(AnChangeEvent e) {
    //        System.out.println("DataObjectsView stateChanged:  " + e.getType());
    switch (e.getType()) {
