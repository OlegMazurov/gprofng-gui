...
public final class LinesView extends FuncListDisp implements AnChangeListener {

  public LinesView() {
    super(AnWindow.getInstance(), AnDisplay.DSP_Lines, 0, AnVariable.HELP_TabsLines);
    setAccessibility(AnLocale.getString("Lines"));
  ...
  public void stateChanged(AnChangeEvent e) {
    //        System.out.println("LinesView stateChanged:  " + e.getType());
    switch (e.getType()) {
